...
# print()
#os.chdir('/home/galdude33/Workspace/nmt_git/')
#print(os.getcwd())

#__package__ = 'nmt_git.nmt'
...
def add_arguments(parser):
    ...
    parser.add_argument("--embed_prefix", type=str, default=None, help="""\
      ...
      """)
    parser.add_argument("--sos_2src", type=str, default="<s_2src>", help="Start-of-sentence symbol. to source")
    parser.add_argument("--sos_2tgt", type=str, default="<s_2tgt>", help="Start-of-sentence symbol. to target")
...
def create_hparams(flags):
    ...
    return tf.contrib.training.HParams(
        ...
        # Vocab
        sos_2src=flags.sos_2src if flags.sos_2src else vocab_utils.SOS_2SRC,
        sos_2tgt=flags.sos_2tgt if flags.sos_2tgt else vocab_utils.SOS_2TGT,
...
def extend_hparams(hparams):
    ...
    src_vocab_size, src_vocab_file = vocab_utils.check_vocab(
        ...
        sos_2src=hparams.sos_2src,
        sos_2tgt=hparams.sos_2tgt,
        eos=hparams.eos,
        unk=vocab_utils.UNK)
